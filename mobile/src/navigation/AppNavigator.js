  ...
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarStyle: { backgroundColor: '#000', borderTopColor: '#222', paddingBottom: 5 },
    ...
    >
      ...
      <Tab.Screen name="Notifications" component={NotificationsScreen} options={{ title: 'Bildirishnomalar' }} />
